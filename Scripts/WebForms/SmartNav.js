...
if ((typeof(window.__smartNav) == "undefined") || (window.__smartNav == null))
{
    ...
    {
        var downup = document.forms;
        for (var i=0; i<downup.length; i++)
        {
            if ((typeof(downup[i].__smartNavEnabled) != "undefined") && (downup[i].__smartNavEnabled != null))
            {
                window.__smartNav.form = downup[i];
